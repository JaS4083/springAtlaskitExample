...
})(["\n  box-sizing: border-box;\n  display: flex;\n  flex-direction: column;\n  /* Flex-basis must be set to auto and width set to 100% instead to prevent box-sizing issues\n   * in IE11.\n   * See https://github.com/philipwalton/flexbugs#7-flex-basis-doesnt-account-for-box-sizingborder-box\n   */\n  flex: 1 1 auto;\n  width: 100%;\n  height: 100%;\n  justify-content: flex-start;\n  transition: padding ", ";\n  padding: 0 ", "px ", "px ", "px;\n\n  ", " ", ";\n"], _sharedVariables.drawerContainerHeaderAnimationSpeed, _sharedVariables.scrollHintSpacing, bottomPadding, _sharedVariables.scrollHintSpacing, (0, _util.whenCollapsed)(_templateObject(), _sharedVariables.gridSize), (0, _util.whenNotCollapsed)(_templateObject2(), function (_ref) {
  var theme = _ref.theme;
  return (0, _util.getProvided)(theme).background.secondary || (0, _util.getProvided)(theme).background.primary;
}, _sharedVariables.scrollHintHeight, bottomPadding, _sharedVariables.scrollBarSize, _sharedVariables.scrollBarSize, function (_ref2) {
  var theme = _ref2.theme;
  return (0, _util.getProvidedScrollbar)(theme).default.background;
}, _sharedVariables.scrollBarSize, function (_ref3) {
