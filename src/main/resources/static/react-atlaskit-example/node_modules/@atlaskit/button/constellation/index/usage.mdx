...
Buttons are triggers for events or actions. They’re commonly used as part of larger components or patterns such as forms, toolbars, modal dialogs or dialog footers.
...
- **Center align** buttons for benefits modals and other modals, with the primary button on the right.
