...
var DropdownMenuStateless = /** @class */ (function (_super) {
    ...
    DropdownMenuStateless.prototype.render = function () {
        ...
        return (react_1.default.createElement(DropdownItemSelectionCache_1.default, null,
            react_1.default.createElement(droplist_1.default, tslib_1.__assign({ appearance: appearance, boundariesElement: boundariesElement, isLoading: isLoading, isOpen: isOpen, onClick: function (e) { return _this.handleClick(e); }, onOpenChange: onOpenChange, position: position, isMenuFixed: isMenuFixed, shouldFitContainer: shouldFitContainer, shouldFlip: shouldFlip, trigger: this.renderTrigger(), onPositioned: this.onDroplistPositioned }, deprecatedProps, { analyticsContext: {
