...
import { DeprecatedItem, DeprecatedItemGroup, DropdownMenuStatelessProps } from '../types';
...
export declare class DropdownMenuStateless extends Component<DropdownMenuStatelessProps, State> {
    ...
    handleKeyboardInteractionForClosed: (event: React.KeyboardEvent<Element>) => void;
    handleKeyboardInteractionsDeprecated: (event: React.KeyboardEvent<HTMLElement>) => void;
...
declare const _default: React.ForwardRefExoticComponent<Pick<Pick<Pick<DropdownMenuStatelessProps, "children" | "shouldFitContainer" | "onOpenChange" | "appearance" | "boundariesElement" | "isLoading" | "isOpen" | "items" | "onItemActivated" | "position" | "isMenuFixed" | "shouldAllowMultilineItems" | "shouldFlip" | "trigger" | "triggerButtonProps" | "triggerType" | "onPositioned" | "testId">, "children" | "trigger" | "triggerButtonProps" | "testId"> & Partial<Pick<Pick<DropdownMenuStatelessProps, "children" | "shouldFitContainer" | "onOpenChange" | "appearance" | "boundariesElement" | "isLoading" | "isOpen" | "items" | "onItemActivated" | "position" | "isMenuFixed" | "shouldAllowMultilineItems" | "shouldFlip" | "trigger" | "triggerButtonProps" | "triggerType" | "onPositioned" | "testId">, "shouldFitContainer" | "onOpenChange" | "appearance" | "boundariesElement" | "isLoading" | "isOpen" | "items" | "onItemActivated" | "position" | "isMenuFixed" | "shouldAllowMultilineItems" | "shouldFlip" | "triggerType" | "onPositioned">> & Partial<Pick<{
    appearance: string;
    boundariesElement: string;
    isLoading: boolean;
    isOpen: boolean;
    ...
    triggerType: string;
    onPositioned: () => void;
}, never>> & React.RefAttributes<any> & import("@atlaskit/analytics-next/dist/cjs/withAnalyticsContext").WithContextProps, "children" | "key" | "shouldFitContainer" | "onOpenChange" | "appearance" | "boundariesElement" | "isLoading" | "isOpen" | "items" | "onItemActivated" | "position" | "isMenuFixed" | "shouldAllowMultilineItems" | "shouldFlip" | "trigger" | "triggerButtonProps" | "triggerType" | "onPositioned" | "testId" | "analyticsContext"> & React.RefAttributes<any>>;
